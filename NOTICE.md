...
Collected: **2026-09-21** (Asia/Shanghai).
...
|---|---|---|---:|---|
| https://github.com/liuyaanng/awesome-gpt-image-2.5 | community | @VoxcatAI; @Goodmanprotocol; @ImagineArt_X; @weiinberg; @meng_dagg695; @saniaspeaks_; … (+30) | 64 | Community X post mirrored in awesome-gpt-image-2.5; remix with attribution |
| EvoLinkAI | github | @Strength04_X; @Gdgtify; @iamaiistudio; @neural_aperture; @Ciri_ai; @WanderingC76; … (+11) | 24 | CC0-1.0 (repo badge) |
...
| https://github.com/PhiMaker5/awesome-gpt-image-2.5-prompts | community | @AI__TSUBAKI; @AIqoro; @AIwithSarah_; @BubbleBrain; @Gdgtify; @Goodmanprotocol; … (+13) | 22 | Community X post mirrored in PhiMaker5/awesome-gpt-image-2.5-prompts; remix with attribution |
...
| https://github.com/SeeAPI/awesome-gpt-image-2.5-prompts | community | @Naiknelofar788; @DeepBlueX0; @MrLarus; @ZHO_ZHO_ZHO; @johnAGI168; @liyue_ai; … (+21) | 36 | Community X post mirrored in SeeAPI/awesome-gpt-image-2.5-prompts; remix with attribution |
| https://github.com/xianyu110/awesome-gpt-image2.5 | community | @modelstoreai; @Diplomeme; @Shorelyn_; @zahra4sure; @ou_zhen599; @Gdgtify; … (+11) | 19 | Community X post mirrored in xianyu110/awesome-gpt-image2.5; remix with attribution |
...
| https://www.elser.ai/blog/gpt-image-2-5-prompt-guide | vendor-blog | Elser AI Blog | 5 | Elser blog examples; remix with attribution |
...
| https://imini.com/blogs/gpt-image-25-guide | vendor-blog | iMini AI | 2 | iMini blog prompt formula example |
| https://findskill.ai/blog/chatgpt-images-2-5-sketch-tool-explained | vendor-blog | FindSkill.ai | 2 | FindSkill blog worked example |
...
| Toolcentral-ai | github | かみいずみさω | 1 | source-attributed catalog |
...
Per-record `attribution.url` is the verifiable source. X-sourced rows link the original status URL; mirrors are credited in `attribution.author`.
